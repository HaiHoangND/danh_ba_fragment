...
class ContactListFragment : Fragment(), MenuProvider {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val names = listOf("John Doe", "Jane Doe", "Alice Smith", "Bob Johnson", "Eve Anderson",
            "Charlie Brown", "Diana Miller", "Frank Wilson", "Grace Davis", "Henry Moore")

        for (i in 1..10) {
            val name = names[i - 1]
            val phoneNumber = "123${i}456789"
